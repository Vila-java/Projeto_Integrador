...
INSERT INTO `freshfood_db`.`vehicle` (`id`, `capacity_box`, `name`) 
VALUES 
('1', '10', 'CARRO'),
('2', '2', 'MOTOCICLETA'),
('3', '30', 'CAMINHAO'); 

INSERT INTO `freshfood_db`.`carrier` (`id`, `address`, `city`, `cpf`, `email`, `first_name`, `last_name`, `neighborhood`, `number`, `phone_number`, `state`, `zip_code`, `vehicle_id`) 
VALUES 
(1, 'Praça da Sé', 'São Paulo', '11122233344', 'bela@meli.com', 'Bella', 'Flores', 'Sé', '3', '12341245', 'SP', '01001001', '1'),
(2, 'Praça da Sé', 'São Paulo', '11122233344', 'margarida@meli.com', 'Margarida', 'Flores', 'Sé', '3', '12341245', 'SP', '01001001', '2'),
(3, 'Praça da Sé', 'São Paulo', '11122233344', 'rosa@meli.com', 'Rosa', 'Flores', 'Sé', '3', '12341245', 'SP', '01001001', '3');
